...
import { SafeAreaView, FlatList, ScrollView, View, ViewPropTypes } from 'react-native'
...
export default class Masonry extends React.Component {
	...
	addItem(item, callback) {
		const [minCol, ...second] = this.sortColumns()
		//this.setState({ alt: !this.state.alt })
		//console.log(item.title, minCol.refs, minCol.getHeight(), second[0].getHeight())
