...
const HeaderGradient = ({navigation, children, absolute=true, closeX = false, title=""}) => {
    return <View style={{width: '100%', height: absolute?80:constants.HEADERHEIGHT, position:absolute?'absolute':'relative', top: 0, zIndex: 500,backgroundColor: constants.TRANSLUCENT, borderBottomRightRadius: 30, borderBottomLeftRadius: 30}}>
          <LinearGradient
