      ...
      <View>
        ...
        <LinearGradient
          ...
          style={{
            ...
            borderRadius: 30,
            zIndex: 40,
          }}><TouchableOpacity style={{borderRadius: 30, color: 'white', justifyContent: 'center', alignItems:'center',paddingVertical: 5, paddingLeft: 10, paddingRight: 10}}><Text style={{color: 'white', fontSize: 14, fontFamily: constants.FONTBOLD}}>{bannerText(price)}</Text></TouchableOpacity>
</LinearGradient>
